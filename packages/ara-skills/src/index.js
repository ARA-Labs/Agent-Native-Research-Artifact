...
${chalk.bold('Install options:')}
  ...
  --skill <id>                  Install one skill (repeatable). Ids: compiler, research-manager, rigor-reviewer, research-visualizer, research-foresight, context-drop, research-fuzzer
