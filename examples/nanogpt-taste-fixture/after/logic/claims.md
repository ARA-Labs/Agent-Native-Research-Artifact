...
- **Taste** (optional):
  - [2026-07-27] `uncertain` on `evidence` — The Cat C gap number is convincing but comes from one eval run; I'd want it to replicate on a second, independently-built RE-Bench artifact before trusting the magnitude.
