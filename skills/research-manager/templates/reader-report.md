# Reader report: contradicting observation
...
- **Observation**: <!-- what was observed — telegraphic, quantitative; positive evidence only,
     never a mere absence -->
- **Basis**: <!-- native refs actually read and/or reader-side evidence pointers
     (logs, frames, run records) -->
- **Repro**: <!-- how to re-check the observation, if applicable -->
- **Reader context**: <!-- who/what produced this: agent/session/harness; environment version
     if known -->
